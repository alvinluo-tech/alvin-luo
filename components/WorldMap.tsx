...
/** 访问过的国家映射表（ISO 编码 + 匹配关键字）——与 data/trips.ts 的 11 国保持同步 */
const VISITED_COUNTRIES: Record<string, { id: string; nameEn: string; nameZh: string }> = {
  "156": { id: "156", nameEn: "China", nameZh: "中国" },
  "702": { id: "702", nameEn: "Singapore", nameZh: "新加坡" },
  "458": { id: "458", nameEn: "Malaysia", nameZh: "马来西亚" },
  "764": { id: "764", nameEn: "Thailand", nameZh: "泰国" },
  "826": { id: "826", nameEn: "United Kingdom", nameZh: "英国" },
  "724": { id: "724", nameEn: "Spain", nameZh: "西班牙" },
  "352": { id: "352", nameEn: "Iceland", nameZh: "冰岛" },
  "250": { id: "250", nameEn: "France", nameZh: "法国" },
  "504": { id: "504", nameEn: "Morocco", nameZh: "摩洛哥" },
  "380": { id: "380", nameEn: "Italy", nameZh: "意大利" },
  "470": { id: "470", nameEn: "Malta", nameZh: "马耳他" },
};

/** 航线轨迹（经纬度坐标对：[出发点 lng, lat], [目的点 lng, lat]）
 *  装饰性弧线：确定的两条主干（大本营杜伦 ↔ 青岛 / 伦敦），
 *  其余行程等补全日期后随 trips 数据一起补充 */
const FLIGHT_ROUTES: [number, number][][] = [
  // 杜伦 (当前 Base) ↔ 中国青岛
  [[-1.5759, 54.7761], [120.38, 36.07]],
  // 杜伦 ↔ 伦敦
  [[-1.5759, 54.7761], [-0.13, 51.51]],
];
