---
slug: "assignment-inspiration"
title: "Assignment Inspiration"
date: "2025-10-29"
updated: "2025-10-30"
category: "course"
tags: ["course assignment", "markdown", "assignment indication"]
summary: "This document summarizes a classroom assignment design, outlining a Titanic-themed time-travel escape with four data-driven challenges that teach analysis, reasoning, and problem-solving."
cover: ""
pinned: false
source: "https://alvinluo-tech.github.io/posts/assignment-inspiration/"
---
...
* **挑战：** 一个填字游戏。
* **如何生成 (第 5 阶段)：** 答案全部来自数据集的“字段名”(Column Names) 或与泰坦尼克号相关的“概念”。
 * **示例线索 (Answers)：**
 * "乘客的父母或子女数量" (答案: `PARCH`)
 * "乘客支付的票价" (答案: `FARE`)
...
* **线索 (Hints)：** 如果玩家输错代码，可以揭示一个额外的、未在图表上显示的数据作为提示。“提示：乘客 2 支付的票价为 7 英镑”。
